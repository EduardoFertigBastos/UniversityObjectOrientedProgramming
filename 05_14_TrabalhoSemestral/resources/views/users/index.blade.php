        ...
        {!! Form::open(['route' => 'users.store', 'method' => 'post', 'class' => '']) !!}
            ...
            <div class="form-row justify-content-center">
                ...
                <div class="form-group col-sm-2 col-md-2 col-lg-2">
                    ...
                    <input type="number" class="form-control" id="codeArea" name="codeArea" placeholder="DDD">
                ...
                <div class="form-group col-sm-6 col-md-8 col-lg-6">
                    ...
                    <input type="number" class="form-control" id="number" name="number" placeholder="Telefone">
